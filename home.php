                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4" >
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between" style="background-color: #2E8B57">
                            ...
                            <?php if($_SESSION['user']['level'] == 'peminjam') : ?>
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card bg-success text-white mb-4">
                                        <div class="card-body" style="background-color: #2E8B57">
                                            <?php echo mysqli_num_rows(mysqli_query($koneksi, "SELECT*FROM koleksi_pribadi"));
                                            ?>   
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <?php
                                    // Periksa apakah pengguna sudah masuk dan memiliki peran tertentu
                                    if (isset($_SESSION['user']) && $_SESSION['user']['level'] != 'peminjam') {
                                        ...
                                        <div class="card bg-dark text-white mb-4">
                                            ...
                                            <div class="card-footer d-flex align-items-center justify-content-between" style="background-color: #2E8B57">
                                                <!-- Konten tambahan dalam footer kartu dapat ditempatkan di sini -->
                                            </div>
                                        </div>
                                    <?php
                                    }
